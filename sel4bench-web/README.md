...
The action expects test result json files generated by the [sel4bench-hw][sel4bench-hw]
action in `results/` and the `metrics.yml` file from the `seL4/sel4bench-results` repo
checked out under `sel4bench-results/`.
